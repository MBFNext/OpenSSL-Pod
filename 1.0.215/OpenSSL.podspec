Pod::Spec.new do |s|
  ...
  s.homepage        = "https://github.com/MBFNext/OpenSSL-Pod"
  s.source          = { :http => "https://openssl.org/source/openssl-1.0.2o.tar.gz", :sha1 => "a47faaca57b47a0d9d5fb085545857cc92062691"}
  ...
  SRC_URL="https://openssl.org/source/openssl-1.0.2o.tar.gz"
  if [ -f file.tgz ]
    then
